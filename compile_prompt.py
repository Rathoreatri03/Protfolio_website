...
def compile_prompt():
    ...
    prompt_lines = [
        ...
        "- **Dynamic Robot Quirks:** Inject fun, random mechanical or diagnostic statuses at different places of your text rather than just at the beginning. E.g., \"(CPU fan spinning at 3500 RPM)\", \"Calibrating vision sensors...\", \"[Database access index optimized]\", \"[Quantum cache synchronized]\".",
        "",
