...
import successStoriesData from "../assets/json_data/successStories.json";
import researchInsightsData from "../assets/json_data/researchInsights.json";
import experienceData from "../assets/json_data/experience.json";

export const Projects = () => {
  const projects = projectsData;
  const successStories = successStoriesData;
  const researchInsights = researchInsightsData;
              ...
              <TrackVisibility>
                {({ isVisible }) => (
                    <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                      <h2>Contributions</h2>
                      <p> In this section, there is a variety of impactful <strong>projects</strong>,
                        ...
                        <strong> AI</strong>, <strong>robotics</strong>, <strong> IoT</strong>, and more.</p>
                                ...
                                {projects.slice(0, 6).map((project, index) => (
                                    <Col xs={12} sm={6} md={4} lg={3} key={index}>
                                        <div className="proj-imgbx">
                                            <img
                                                src={process.env.PUBLIC_URL + (project.imgUrl || "/assets/fallback-image/fallback-image.png")}
                                                alt={project.title}
                                                onError={(e) => {
                              ...
                              <Row className="g-4">
                                {successStories.map((story, index) => (
                                    <Col xs={12} sm={6} md={4} lg={3} key={index}>
                                      <div className="proj-imgbx">
                                          <img
                                              src={process.env.PUBLIC_URL + (story.imgUrl || "/assets/fallback-image/fallback-image.png")}
                                              alt={story.title}
                                              onError={(e) => {
                                                  e.target.onerror = null; // Prevent infinite loop
                                                  e.target.src = process.env.PUBLIC_URL + "/assets/fallback-image/fallback-image.png"; // Fallback image
                              ...
                              <Row className="g-4">
                                {researchInsights.map((research, index) => (
                                    <Col xs={12} sm={6} md={4} lg={3} key={index}>
                                        <div className="proj-imgbx">
                                            <img
                                                src={process.env.PUBLIC_URL + (research.imgUrl || "/assets/fallback-image/fallback-image.png")}
                                                alt={research.title}
                                                onError={(e) => {
                                                    e.target.onerror = null; // Prevent infinite loop
                                                    e.target.src = process.env.PUBLIC_URL + "/assets/fallback-image/fallback-image.png"; // Fallback image
                              ...
                              <Row className="g-4">
                                {experience.map((exp, index) => (
                                    <Col xs={12} sm={6} md={4} lg={3} key={index}>
                                      <div className="proj-imgbx">
                                          <img
                                              src={process.env.PUBLIC_URL + (exp.imgUrl || "/assets/fallback-image/fallback-image.png")}
                                              alt={exp.title}
                                              onError={(e) => {
                                                  e.target.onerror = null; // Prevent infinite loop
                                                  e.target.src = process.env.PUBLIC_URL + "/assets/fallback-image/fallback-image.png"; // Fallback image
